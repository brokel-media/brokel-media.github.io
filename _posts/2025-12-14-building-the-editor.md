...
author: ["lucaa2000", "Github Copilot"]
---
...
3.  **The Magic**: The encrypted token is stored in a file on this website. When a user visits the `/contribute` page, they are asked for the password.
...
1.  Go to the **[Contribute Page](/contribute)**.
